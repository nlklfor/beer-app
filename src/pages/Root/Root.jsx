    ...
    return (
        <div className="app">
            <header className="app-header">
                ...
                <img src={logo} className="header-logo" alt="logo" width={100} height={80} />
            </header>
            ...
            <div className="app-content">
                {props.beers.map((obj) => {
                    return (
                        <Card id={obj.id} key={obj.id} name={obj.name} image={obj.image_url} tagline={obj.tagline} description={obj.description} contributed={obj.contributed_by}/>
                    )
                })}
            </div>
